    ...
    private function setDummyConfig(bool $widgets): void
    {
        ...
        $conn->insert(
            ...
            [
                ...
                'index_1' => '1',
                'index_2' => 'sequra',
                'data'    => '{"class_name":"SeQura\\\\Core\\\\BusinessLogic\\\\DataAccess\\\\ConnectionData\\\\Entities\\\\ConnectionData","id":' . $id . ',"storeId":"1","deployment":"sequra","connectionData":{"environment":"sandbox","merchantId":"","deployment":"sequra","authorizationCredentials":{"username":"dummy_automated_tests","password":"' . $password . '"}}}',
            ]
        );
        $conn->insert(
            $table_name,
            [
                ...
                'index_1' => '1',
                'index_2' => 'svea',
                'data'    => '{"class_name":"SeQura\\\\Core\\\\BusinessLogic\\\\DataAccess\\\\ConnectionData\\\\Entities\\\\ConnectionData","id":' . $id . ',"storeId":"1","deployment":"svea","connectionData":{"environment":"sandbox","merchantId":"","deployment":"svea","authorizationCredentials":{"username":"dummy_automated_tests","password":"' . $password . '"}}}',
            ]
        );
        ...
        $conn->insert(
            ...
            [
                ...
                'data'    => '{"class_name":"SeQura\\\\Core\\\\BusinessLogic\\\\DataAccess\\\\Credentials\\\\Entities\\\\Credentials","id":' . $id . ',"storeId":"1","country":"ES","merchantId":"dummy_automated_tests","credentials":{"merchantId":"dummy_automated_tests","country":"ES","currency":"EUR","assetsKey":"' .  getenv('SQ_ASSETS_KEY') . '","payload":{"ref":"dummy_automated_tests","name":null,"country":"ES","allowed_countries":["ES"],"currency":"EUR","assets_key":"'. getenv('SQ_ASSETS_KEY') .'","contract_options":["allow_first_instalment_delay"],"extra_information":{"type":"regular","phone_number":""},"verify_signature":false,"signature_secret":"d0d7908d2018f5a3ae37358ed66bc17a","confirmation_path":"default","realm":"sequra"},"deployment":"sequra"}}',
            ]
        );
        $conn->insert(
            $table_name,
            [
                ...
                'data'    => '{"class_name":"SeQura\\\\Core\\\\BusinessLogic\\\\DataAccess\\\\Credentials\\\\Entities\\\\Credentials","id":' . $id . ',"storeId":"1","country":"PT","merchantId":"dummy_automated_tests_pt","credentials":{"merchantId":"dummy_automated_tests_pt","country":"PT","currency":"EUR","assetsKey":"' .  getenv('SQ_ASSETS_KEY') . '","payload":{"ref":"dummy_automated_tests_pt","name":null,"country":"PT","allowed_countries":["ES"],"currency":"EUR","assets_key":"'. getenv('SQ_ASSETS_KEY') .'","contract_options":[],"extra_information":{"type":"regular","phone_number":""},"verify_signature":false,"signature_secret":"3446a5a57c5a1c3dabbd3a9bcd770f62","confirmation_path":"down_payment_on_confirmation","realm":"svea"},"deployment":"svea"}}',
            ]
        );
        $conn->insert(
            $table_name,
            [
                ...
                'data'    => '{"class_name":"SeQura\\\\Core\\\\BusinessLogic\\\\DataAccess\\\\Credentials\\\\Entities\\\\Credentials","id":' . $id . ',"storeId":"1","country":"FR","merchantId":"dummy_automated_tests_fr","credentials":{"merchantId":"dummy_automated_tests_fr","country":"FR","currency":"EUR","assetsKey":"' .  getenv('SQ_ASSETS_KEY') . '","payload":{"ref":"dummy_automated_tests_fr","name":null,"country":"FR","allowed_countries":["ES"],"currency":"EUR","assets_key":"'. getenv('SQ_ASSETS_KEY') .'","contract_options":[],"extra_information":{"type":"regular","phone_number":""},"verify_signature":false,"signature_secret":"aad0bdc1a4a7c2eac655842bf86f624d","confirmation_path":"down_payment_on_confirmation","realm":"svea"},"deployment":"svea"}}',
            ]
        );
        $conn->insert(
            $table_name,
            [
                ...
                'data'    => '{"class_name":"SeQura\\\\Core\\\\BusinessLogic\\\\DataAccess\\\\Credentials\\\\Entities\\\\Credentials","id":' . $id . ',"storeId":"1","country":"IT","merchantId":"dummy_automated_tests_it","credentials":{"merchantId":"dummy_automated_tests_it","country":"IT","currency":"EUR","assetsKey":"' .  getenv('SQ_ASSETS_KEY') . '","payload":{"ref":"dummy_automated_tests_it","name":null,"country":"IT","allowed_countries":["ES"],"currency":"EUR","assets_key":"'. getenv('SQ_ASSETS_KEY') .'","contract_options":[],"extra_information":{"type":"regular","phone_number":""},"verify_signature":false,"signature_secret":"f1bd4509c8f5ff441bde35da35f58bb8","confirmation_path":"down_payment_on_confirmation","realm":"svea"},"deployment":"svea"}}',
            ]
        );
        // Deployment
        $conn->insert(
        ...
        $conn->insert(
            ...
            [
                ...
                'type'    => 'WidgetSettings',
                'index_1' => '1',
                'data'    => '{"class_name":"SeQura\\\\Core\\\\BusinessLogic\\\\DataAccess\\\\PromotionalWidgets\\\\Entities\\\\WidgetSettings","id":' . $id . ',"storeId":"1","widgetSettings":{"enabled":true,"displayOnProductPage":' . $display . ',"showInstallmentsInProductListing":' . $display . ',"showInstallmentsInCartPage":' . $display . ',"miniWidgetSelector":"","widgetConfiguration":"{\"alignment\":\"center\",\"amount-font-bold\":\"true\",\"amount-font-color\":\"#1C1C1C\",\"amount-font-size\":\"15\",\"background-color\":\"white\",\"border-color\":\"#B1AEBA\",\"border-radius\":\"\",\"class\":\"\",\"font-color\":\"#1C1C1C\",\"link-font-color\":\"#1C1C1C\",\"link-underline\":\"true\",\"no-costs-claim\":\"\",\"size\":\"M\",\"starting-text\":\"only\",\"type\":\"banner\"}","widgetSettingsForProduct":{"priceSelector":".price-container .price","locationSelector":".actions .action.primary.tocart","altPriceSelector":"[data-price-type=\"finalPrice\"] .price","altPriceTriggerSelector":".bundle-actions","customWidgetSettings":[]},"widgetSettingsForCart":{"priceSelector":".grand.totals .price","locationSelector":".cart-summary","widgetProduct":"pp3"},"widgetSettingsForListing":{"priceSelector":"","locationSelector":"","widgetProduct":"pp3"}}}',
            ],
        );
    }

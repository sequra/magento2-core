    ...
    private function setDummyConfig(bool $widgets): void
    {
        ...
        $conn->insert(
            ...
            [
                ...
                'index_1' => '1',
                'data'    => '{"class_name":"SeQura\\\\Core\\\\BusinessLogic\\\\DataAccess\\\\CountryConfiguration\\\\Entities\\\\CountryConfiguration","id":'. $id .',"storeId":"1","countryConfigurations":[{"countryCode":"ES","merchantId":"dummy_automated_tests"},{"countryCode":"IT","merchantId":"dummy_automated_tests_it"},{"countryCode":"PT","merchantId":"dummy_automated_tests_pt"}]}',
            ]
        );
        $conn->insert(
            $table_name,
            [
                ...
                'index_1' => '1',
                'index_2' => 'IT',
                'data'    => '{"class_name":"SeQura\\\\Core\\\\BusinessLogic\\\\DataAccess\\\\Credentials\\\\Entities\\\\Credentials","id":'. $id .',"storeId":"1","country":"IT","credentials":{"merchantId":"dummy_automated_tests_it","country":"IT","currency":"EUR","assetsKey":"'.  getenv('SQ_ASSETS_KEY') .'","payload":{"ref":"dummy_automated_tests_it","name":null,"country":"IT","allowed_countries":["ES"],"currency":"EUR","assets_key":"ADc3ZdOLh4","contract_options":[],"extra_information":{"type":"regular","phone_number":""},"verify_signature":false,"signature_secret":"","confirmation_path":"default","realm":"silent_eu:dummy_automated_tests_it"}}}',
            ]
        );
        $conn->insert(
            $table_name,
            [
                ...
                'index_1' => '1',
                'index_2' => 'PT',
                'data'    => '{"class_name":"SeQura\\\\Core\\\\BusinessLogic\\\\DataAccess\\\\Credentials\\\\Entities\\\\Credentials","id":'. $id .',"storeId":"1","country":"IT","credentials":{"merchantId":"dummy_automated_tests_pt","country":"PT","currency":"EUR","assetsKey":"'.  getenv('SQ_ASSETS_KEY') .'","payload":{"ref":"dummy_automated_tests_pt","name":"Dummy Automated Tests Pt","country":"PT","allowed_countries":["ES"],"currency":"EUR","assets_key":"ADc3ZdOLh4","contract_options":[],"extra_information":{"type":"regular","phone_number":""},"verify_signature":false,"signature_secret":"","confirmation_path":"default","realm":"silent_eu:dummy_automated_tests_pt"}}}',
            ]
        );
        $conn->insert(
            $table_name,
            [
                ...
                'index_1' => '1',
                'index_2' => 'ES',
                'data'    => '{"class_name":"SeQura\\\\Core\\\\BusinessLogic\\\\DataAccess\\\\Credentials\\\\Entities\\\\Credentials","id":'. $id .',"storeId":"1","country":"IT","credentials":{"merchantId":"dummy_automated_tests","country":"ES","currency":"EUR","assetsKey":"'.  getenv('SQ_ASSETS_KEY') .'","payload":{"ref":"dummy_automated_tests","name":null,"country":"ES","allowed_countries":["ES"],"currency":"EUR","assets_key":"ADc3ZdOLh4","contract_options":["allow_first_instalment_delay"],"extra_information":{"type":"regular","phone_number":""},"verify_signature":false,"signature_secret":"","confirmation_path":"default","realm":"sequra"}}}',
            ]
        );
        $conn->insert(
            $table_name,
